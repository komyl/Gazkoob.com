...
<head>
    ...
    <?php wp_head(); /* This is the standard, reliable way to load assets */ ?>
</head>
...
<section class="banner" id="home">
    ...
    <div class="banner-content">
        ...
        <p class="banner-text">
            ارائه دهنده خدمات تخصصی سرامیک،<span class="mobile-break"><br></span> کاور و صافکاری PDR در <span class="highlight-location">مشهد</span>
        </p>
